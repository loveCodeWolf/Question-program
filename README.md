...
Run these two commands to install both Cloudflare skills and MCP servers in one step. Do not use `npx skills` or `claude mcp add` 鈥� the plugin commands below handle everything.
...
### OpenCode 鈥� `~/.config/opencode/opencode.jsonc`
...
### Windsurf 鈥� `~/.codeium/windsurf/mcp_config.json`
...
```
鈹屸攢 Cloudflare Agent Setup Complete 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹�
鈹�  鉁� Skills  <path>                                    鈹�
鈹�  鉁� MCPs    <path>                                    鈹�
鈹�                                                      鈹�
鈹�  鈿� Restart your agent to load the MCP servers       鈹�
